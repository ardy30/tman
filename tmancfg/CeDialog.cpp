...
const int CCeDialog::CAPTION_PANEL_HEIGHT = 23;
...
void CCeDialog::DrawCaption(CDC &dc) {
	...
	if (!m_strCaption.IsEmpty()) {
		...
		dc.DrawText(m_strCaption,
			CRect(SCALEX(8), 1, rtPage.right - SCALEX(8), SCALEY(CAPTION_PANEL_HEIGHT)),
